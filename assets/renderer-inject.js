((cssText, artDataUrl, themeConfig) => {
  ...
  const applyTheme = (root) => {
    ...
    root.dataset.dreamSkinAppearance = THEME.appearance === "light" ? "light" : "dark";
    const variables = {
    ...
    root.style.setProperty("--dream-skin-name", cssString(THEME.name || "Codex Immersive Skin"));
  ...
  const ensure = () => {
    ...
    if (!chrome || chrome.parentElement !== document.body) {
      ...
      chrome.innerHTML = `
        <div class="dream-skin-brand">
          <span class="dream-skin-brand-mark">◉</span>
    ...
    chrome.querySelector(".dream-skin-brand b").textContent = THEME.name || "Codex Immersive Skin";
    chrome.querySelector(".dream-skin-brand small").textContent = THEME.brandSubtitle || "CODEX IMMERSIVE SKIN";
    chrome.querySelector(".dream-skin-status span").textContent = THEME.statusText || "IMMERSIVE MODE";
  ...
  const cleanup = () => {
    ...
    delete document.documentElement?.dataset.dreamSkinAppearance;
