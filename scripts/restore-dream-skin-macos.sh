...
if [ "$UNINSTALL" = "true" ]; then
  /bin/rm -f "$HOME/Desktop/Codex Immersive Skin.command"
  /bin/rm -f "$HOME/Desktop/Codex Immersive Skin - Customize.command"
  /bin/rm -f "$HOME/Desktop/Codex Immersive Skin - Verify.command"
  /bin/rm -f "$HOME/Desktop/Codex Immersive Skin - Restore.command"
fi

printf 'Codex Immersive Skin was removed and the requested macOS restore actions completed successfully.\n'
